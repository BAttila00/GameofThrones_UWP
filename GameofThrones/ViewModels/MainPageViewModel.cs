...
namespace GameofThrones.ViewModels {
    ...
    public class MainPageViewModel : ViewModelBase {
        ...
        public override async Task OnNavigatedToAsync(object parameter, NavigationMode mode, IDictionary<string, object> state) {
            ...
            ThroneBooks = new ObservableCollection<Book>(HolderClassSingleton.ThroneBooks);
            Characters = new ObservableCollection<Character>(HolderClassSingleton.Characters);
            Houses = new ObservableCollection<House>(HolderClassSingleton.Houses);
            ...
            switch (content) {
                case "Books":
                    if (!ThroneBooks.Any()) {
                        ...
                        HolderClassSingleton.ThroneBooks = books;
                    }
                    break;
                case "Characters":
                    if (!Characters.Any()) {
                        ...
                        HolderClassSingleton.Characters = characters;
                    }
                    break;
                case "Houses":
                    if (!Houses.Any()) {
                       ...
                       HolderClassSingleton.Houses = houses;
                    }
                    break;
                default:
                    break;
